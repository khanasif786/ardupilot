...
const AP_Param::GroupInfo AP_Follow::var_info[] = {
    ...
    // @User: Standard
    // @Range: 0.0 0.5
    AP_GROUPINFO("_OBJ_FOLL_M", 19, AP_Follow, _object_follow_margin, 0.05),
    ...
    // @User: Standard
    // @Units: ms
    AP_GROUPINFO("_POI_DELAY", 20, AP_Follow, _poi_delay, 2000.0),
    ...
    // @User: Standard
    // @Units: Degrees
    AP_GROUPINFO("_OBJ_Y_RST", 21, AP_Follow, _object_follow_yaw_reset, 30.0),
    ...
    // @User: Standard
    // @Units: Degrees
    AP_GROUPINFO("_OBJ_P_RST", 22, AP_Follow, _object_follow_pitch_reset, 30.0),
#endif
